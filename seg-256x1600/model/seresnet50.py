...
if __name__ == '__main__':
    ...
    net = Unet('se_resnet50',encoder_weights=None,classes=4,activation='sigmoid')
    seg_path = 'weights/model_RAdamsteppytorchBCE92410.pth'
    ...
    net.load_state_dict(seg_state,strict=True)
